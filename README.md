...
Then run `/init` — Copilot will read `CLAUDE.md` and understand the framework. Tell it:
> "帮我将这个 repo 里的 agents 安装到我本地"

Copilot will copy skills to `~/.copilot/skills/` and append agent rules to `~/.copilot/copilot-instructions.md`.
